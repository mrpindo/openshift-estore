...
class DjangoAppPlugin(plugins.SimplePlugin):
    def __init__(self, bus, settings_module='tokoku.settings', wsgi_http_logger=HTTPLogger):
    ...
    def start(self):
        ...
        #settings = self.load_settings()		##Break Up!
        ...
        if ON_OPENSHIFT:
            ...
            static_handler = cherrypy.tools.staticdir.handler(
                section="/",
                dir="static",
                root="/home/endik/Documents/WorkSpace/Python/endikApp/VENV/OPENSHIFT/toko/wsgi/"
            )
